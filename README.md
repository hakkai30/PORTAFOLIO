# 💻 Robin_OS | Terminal-Themed Developer Portfolio
...
* **Frontend:** HTML5 semántico, CSS3 (con variables CSS y animaciones `@keyframes`), Vanilla JavaScript (ES6+).
* **Framework CSS:** Bootstrap 5.3 (utilizado principalmente para el sistema de grid y componentes responsive como el Navbar).
